...
export function BottomNavigation({ 
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none pb-3 px-5 pb-[calc(0.75rem+env(safe-area-inset-bottom))]">
      <div className="mx-auto w-full max-w-[540px] sm:max-w-[600px]">
        <motion.nav 
        ...
        >
          ...
          {/* Tab container */}
          <div className="relative flex items-center justify-between gap-3 px-6 py-1.5">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              const isActive = activeTab === tab.id;
              const pillWidth = '4.7rem';
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    ...
                    "min-h-[52px] min-w-[60px] px-2 py-1",
