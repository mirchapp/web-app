            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  style={{ top: isPWA ? `${safeAreaInsets.top + 16}px` : '16px', left: '1rem' }}
                >
                ...
                <div className="container mx-auto px-4 pb-32 relative z-10" style={{ paddingTop: isPWA ? `${safeAreaInsets.top + 48}px` : '48px' }}>
