Goal: Always produce an "uber elegant, sleek, liquid glass" UI, mobile‑first and responsive by default. We primarily design against iPhone 14 Pro Max (viewport ~430×932, viewport-fit=cover), and scale up.
